...
- El registro usa nombre de granja o empresa, telefono, email y contraseña.
...
La ruta raiz redirige automaticamente a `/admin/dashboard`, `/portal/dashboard` o `/auth/login` segun el usuario autenticado.

## Observaciones

- El frontend ya opera bajo la marca Norgtech, pero todavía conviene revisar el naming histórico restante del repositorio si se va a publicar externamente.
