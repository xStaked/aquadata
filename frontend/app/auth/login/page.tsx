...
export default function LoginPage() {
  ...
  const handleLogin = async (e: FormEvent) => {
    ...
    try {
      ...
      router.replace(isAdminRole(profile?.role) ? '/admin/dashboard' : '/portal/dashboard')
    } catch (error: unknown) {
        ...
        <div className="flex flex-col gap-6">
          <div className="flex flex-col items-center gap-2">
            ...
            <div className="flex items-center gap-1 text-muted-foreground">
              ...
              <p className="text-sm">Operación técnica para avícola y porcino</p>
            </div>
          </div>
                ...
                <div className="flex flex-col gap-6">
                  <div className="grid gap-2">
                    ...
                    <Input
                      id="email"
                      type="email"
                      placeholder="asesor@norgtech.com"
                      required
                      value={email}
