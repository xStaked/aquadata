...
import { Building2, Leaf, CheckCircle } from 'lucide-react'
        ...
        <div className="flex flex-col gap-6">
          <div className="flex flex-col items-center gap-2">
            <div className="flex items-center gap-2.5 text-primary">
              ...
              <span className="text-2xl font-bold tracking-tight text-foreground">Norgtech</span>
            </div>
            <div className="flex items-center gap-1 text-muted-foreground">
              <Leaf className="h-4 w-4" />
              <p className="text-sm">Actualiza tu acceso de forma segura</p>
            </div>
          </div>
              ...
              {success ? (
                <div className="flex flex-col items-center gap-4">
                  ...
                  <p className="text-sm text-muted-foreground text-center">
                    Contrasena actualizada correctamente. Redirigiendo al inicio de sesión...
                  </p>
                </div>
              ) : (
